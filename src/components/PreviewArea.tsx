...
Um dos bombons está cortado ao meio, exibindo o interior com apenas uma camada: da base ao topo, ocupando 100% da altura do bombom, uma única camada uniforme cremosa de ${selection.ganache.nome}. 
